    ...
    <>
      ...
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, padding: "0 40px", height: 72, display: "flex", alignItems: "center", justifyContent: "space-between", background: scrolled ? "rgba(10,31,68,0.97)" : "transparent", backdropFilter: scrolled ? "blur(20px)" : "none", borderBottom: scrolled ? "1px solid rgba(212,175,55,0.2)" : "none", transition: "all 0.4s" }}>
        ...
        <div className="desktop-nav" style={{ display: "flex", alignItems: "center", gap: 36 }}>
          {NAV_LINKS.map(l => <a key={l} href={`/#${l.toLowerCase()}`} className={`nav-link${l === "About" ? " active" : ""}`}>{l}</a>)}
            ...
            <AnimSection>
              <div style={{ position: "relative", display: "flex", justifyContent: "center" }}>
                ...
                <div style={{ width: 300, height: 300, borderRadius: "50%", border: `4px solid ${GOLD}`, overflow: "hidden", boxShadow: `0 0 0 10px rgba(212,175,55,0.1), 0 30px 80px rgba(0,0,0,0.4)`, animation: "float 7s ease-in-out infinite", zIndex: 1, flexShrink: 0 }}>
                  <img src="https://images.unsplash.com/photo-1560250097-0b93528c311a?w=600&q=80" alt="Paul Nyang'wara" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                </div>
