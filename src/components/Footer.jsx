...
import { GOLD, DARK_BG } from '../constants'; // ADR-029
...
const SOCIALS = [
  { label: "LinkedIn",  href: "https://linkedin.com/in/oprobandi",  Icon: IconLinkedIn  },
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ marginBottom: 48 }}>
            <Link to="/" style={{ textDecoration: "none", display: "inline-flex", alignItems: "center", gap: 14, marginBottom: 16 }}>
              <img src="/neurospark-logo.jpg" alt="NeuroSpark Logo" width={50} height={50} style={{ width: 50, height: 50, borderRadius: "50%", objectFit: "cover", flexShrink: 0 }} />
              <div>
